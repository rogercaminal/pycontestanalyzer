...
class PlotTimeVsBandVsContinent(PlotBase):
    ...
    def do_plot(self, contest, doSave, options=""):
        ...
        fig["layout"].update(
                ...
                yaxis1=dict(title="Band", tickmode="array", tickvals=list(range(1, 7)), ticktext=["10m", "15m", "20m", "40m", "80m", "160m"]),
                yaxis2=dict(title="Band", tickmode="array", tickvals=list(range(1, 7)), ticktext=["10m", "15m", "20m", "40m", "80m", "160m"]),
                yaxis3=dict(title="Band", tickmode="array", tickvals=list(range(1, 7)), ticktext=["10m", "15m", "20m", "40m", "80m", "160m"]),
                yaxis4=dict(title="Band", tickmode="array", tickvals=list(range(1, 7)), ticktext=["10m", "15m", "20m", "40m", "80m", "160m"]),
                yaxis5=dict(title="Band", tickmode="array", tickvals=list(range(1, 7)), ticktext=["10m", "15m", "20m", "40m", "80m", "160m"]),
                yaxis6=dict(title="Band", tickmode="array", tickvals=list(range(1, 7)), ticktext=["10m", "15m", "20m", "40m", "80m", "160m"]),
                width=750,
                height=750,
                )
