...
from pandas import concat, to_datetime, to_timedelta
...
AVAILABLE_FEATURES = {
    "valid_qsos": ["cum_valid_qsos", "Valid QSOs"],
    "qso_points": ["cum_qso_points", "QSO points"],
    "multipliers": ["cum_mult", "Multipliers"],
    "dxcc": ["cum_dxcc", "DXCC multipliers"],
    "zones": ["cum_zone", "Zone multipliers"],
    "score": ["cum_contest_score", "Contest score"],
    "points_per_qso": ["cum_points_per_qso", "Cumulative points per QSO"],
    "mult_worth_points": ["mult_worth_points", "# points equivalent to multiplier"],
    "mult_worth_qsos": ["mult_worth_qsos", "# QSOs equivalent to multiplier"],
}
