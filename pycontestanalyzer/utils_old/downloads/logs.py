...
def get_log(contest, callsign, year, mode):
    ...
    try:
        ...
        if contest == "cqww":
            logging.info(
                "Getting the log from http://www.cqww.com/publiclogs/{}{}/{}.log".format(
                    year, mode, callsign.lower()
                )
            )
            website_address = (
                "http://www.cqww.com/publiclogs/{}{}/{}.log".format(
                    year, mode, callsign.lower()
                )
            )
        elif contest == "cqwpx":
            logging.info(
                "Getting the log from http://www.cqwpx.com/publiclogs/{}{}/{}.log".format(
                    year, mode, callsign.lower()
                )
            )
            website_address = (
                "http://www.cqwpx.com/publiclogs/{}{}/{}.log".format(
                    year, mode, callsign.lower()
                )
            )
...
def get_list_of_logs(contest_type, year, mode):
    ...
    if contest_type == "cqww":
        website_address = "http://www.cqww.com/publiclogs/{}{}/".format(
            year, mode
        )
    elif contest_type == "cqwpx":
        website_address = "http://www.cqwpx.com/publiclogs/{}{}/".format(
            year,
            mode,
        )
