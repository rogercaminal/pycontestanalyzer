...
from pycontestanalyzer.utils.morse import MorseConverter
...
class PlotLenghtCallMorse(PlotBase):
    ...
    def do_plot(self, contest, doSave, options=""):
        ...
        mconvert = MorseConverter(mylength)
        ...
        data = [
            go.Histogram(
                x=qsos_length,
                name="All",
                xbins=dict(start=0, end=6, size=0.2),
        ...
        layout = go.Layout(
            ...
            annotations=[
                dict(
                    ...
                    text=str(
                        "<b>TEST %s %s @ %d WPM</b>"
                        % (contest.callsign, contest.callsign, mylength)
                    ),
                    showarrow=True,
                    arrowhead=2,
                    arrowsize=1,
                ...
                dict(
                    ...
                    yref="y",
                    text=str(
                        "<b>TU %s @ %d WPM</b>" % (contest.callsign, mylength)
                    ),
                    showarrow=True,
                    arrowhead=2,
                    arrowsize=1,
                ...
                dict(
                    ...
                    yref="y",
                    text=str(
                        "<b>%s 5NN @ %d WPM</b>" % (contest.callsign, mylength)
                    ),
                    showarrow=True,
                    arrowhead=2,
                    arrowsize=1,
