...
class PlotQSOsVsTimeStationtype(PlotBase):
    ...
    def do_plot(self, contest, doSave, options=""):
        qsos_running = contest.log[(contest.log["station_type"] == "running")][
            "hour"
        ]
        qsos_inband = contest.log[(contest.log["station_type"] == "inband")][
            "hour"
        ]
        qsos_multi = contest.log[(contest.log["station_type"] == "multi")][
            "hour"
        ]
